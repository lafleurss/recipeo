...
public class CreateRecipeRequest {
    ...
    private CreateRecipeRequest(String recipeName, String userId, Integer servings, Integer prepTime,
                               Integer cookTime, Integer totalTime, List<String> ingredients,
    ...
    public static class Builder {
        ...
        public CreateRecipeRequest build() {
            return new CreateRecipeRequest(recipeName, userId, servings, prepTime,
