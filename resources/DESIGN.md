...
# API Endpoints
#### Shilpa TODOs/Questions
* TODO - DO I NEED MODELS? TALK to Charlie about this.
* Need to understand how Curl commands would work for GET with Amazon Cognito.
* Would I need to pass userId in my Get,Post,Put requests as query param to validate userId before performing the action?
...
#### TODO - once I get the approval from Charlie on everything else.
